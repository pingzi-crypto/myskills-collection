...
Handle same-title Mechanism Cards safely.

This flow exists to prevent:

- duplicate cards for the same mechanism
- silent overwrites
- unnecessary resets of card maturity

## Trigger

Use this flow when a file with the same mechanism title already exists at:
...
- do not claim `expert-ready` unless the card includes reusable routing, switching, or arbitration rules
