...
Resolve one `VAULT_ROOT` before reading the mechanism template or writing any card.
...
- If the mechanism output directory is missing, create it before writing the new card.
