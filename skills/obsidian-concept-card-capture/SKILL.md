...
1. Resolve `VAULT_ROOT` using [../shared/learning-card-core/references/vault-path-protocol.md](../shared/learning-card-core/references/vault-path-protocol.md) and the target paths in [references/concept-card-spec.md](references/concept-card-spec.md).
...
- Prefer `scripts/render_concept_card.py` to generate the final card layout for new cards, following [../shared/learning-card-core/references/deterministic-render-protocol.md](../shared/learning-card-core/references/deterministic-render-protocol.md).
