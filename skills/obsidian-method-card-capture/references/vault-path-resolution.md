...
Resolve one `VAULT_ROOT` before reading the method template or writing any card.
...
- If the method output directory is missing, create it before writing the new card.
